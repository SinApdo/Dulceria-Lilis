    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uom_compra', models.CharField(blank=True, max_length=50, null=True, verbose_name='UOM Compra')),
                ('uom_venta', models.CharField(blank=True, max_length=50, null=True, verbose_name='UOM Venta')),
                ('factor_conversion', models.DecimalField(decimal_places=2, default=1, max_digits=10, verbose_name='Factor Conversión')),
                ('costo_estandar', models.PositiveIntegerField(default=0, verbose_name='Costo Estándar')),
                ('costo_promedio', models.PositiveIntegerField(default=0, editable=False, verbose_name='Costo Promedio')),
                ...
                ('ficha_tecnica_url', models.FileField(blank=True, null=True, upload_to='fichas/', verbose_name='Ficha Técnica')),
